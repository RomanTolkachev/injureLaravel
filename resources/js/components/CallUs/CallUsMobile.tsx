...
export const CallUsMobile: FunctionComponent<{ employee: IEmployee }> = ({
    ...
    return (
        <div className="relative mx-auto mb-10 min-h-[228px] w-[390px] overflow-hidden rounded-3xl pt-6 shadow-[0px_12px_51px_-12px_rgba(34,60,80,0.26);] md:hidden">
            <>
                ...
                <div
                    onClick={() => dispatch(openCallUsModal())}
                    className="absolute left-1/2 top-0 z-[4] flex h-full w-full max-w-[480px] -translate-x-1/2 items-end px-10 pb-10"
                >
                    <ButtonCallUs color={"whiteColor"}>
                        оставить заявку
                    </ButtonCallUs>
                </div>
            </>
